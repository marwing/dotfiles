...
# Uncomment the following line to disable auto-setting terminal title to current path.
...
plugins=(
    ...
    zsh-syntax-highlighting # exactly what the name says
)
...
# maximum history size LONG_MAX in limits.h based on zsh mailing list (http://www.zsh.org/mla/users/2012/msg00691.html)
...
# use fzf for history reverse search and file search if available
...
############################################ copied from https://github.com/zsh-users/zsh-autosuggestions/issues/238#issuecomment-389324292
